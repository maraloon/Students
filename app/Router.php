...
class Router
{
     ...
     */
    //Если пользователь обращается к папке "site.ru/path/to/public", то Апач редиректит на "site.ru/path/to/public/", добавляя слеш в конец. А если  к "site.ru/path/to/public/action", то оставляет как есть.
